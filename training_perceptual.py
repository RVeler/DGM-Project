...
from transformers import AutoFeatureExtractor, ClapModel #myimpotrs
import torchaudio
from perceptual_utils import CustomizedClapFeatureExtractor

model = ClapModel.from_pretrained("laion/clap-htsat-unfused")#myaddition
model.eval()
for param in model.parameters():
  param.requires_grad = False
feature_extractor = AutoFeatureExtractor.from_pretrained("laion/clap-htsat-unfused")#myaddition
feature_extractor_ours = CustomizedClapFeatureExtractor(
    feature_size=64,
    sampling_rate=48000,
    padding_value=0.0,
    padding_side='right',
